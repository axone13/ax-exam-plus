...
function site_pic($pic)
{
    return base_url('assets/site/pics/' . $pic);
}

function dota2_medal_pic($pic)
{
    return base_url('assets/site/dota2_medals/' . $pic);
}

function dota2_behavior_pic($pic)
{
    return base_url('assets/site/dota2_behaviors/' . $pic);
}

function csgo_rank_pic($pic)
{
    return base_url('assets/site/csgo_ranks/' . $pic);
}

function avatar_pic($pic)
{
    return base_url('assets/site/avatar_pics/' . $pic);
}

function game_icon_pic($pic)
{
    return base_url('assets/site/games_logo/' . $pic);
}
